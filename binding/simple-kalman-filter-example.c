/*
    ...
    on a LSM9DS0 connected to a Renesas Porter expansion board.
    http://elinux.org/R-Car/Boards/Porter:PEXT01#How_to_test_some_capabilities_of_Porter_EXT01

    Copyright (C) 2014  Mark Williams
    Copyright (C) 2016  Romain Forlot
